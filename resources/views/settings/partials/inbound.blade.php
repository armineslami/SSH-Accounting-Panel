<section class="p-8 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __("Change the default settings of inbounds.") }}
        </p>
    </header>
        ...
        <div class="">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                <div>
                    ...
                    <x-text-input id="inbound_traffic_limit" name="inbound_traffic_limit" type="text"
                ...
                <div>
                    ...
                    <x-text-input id="inbound_max_login" name="inbound_max_login" type="text"
                                  class="mt-1 block w-full"
                ...
                <div>
                    ...
                    <x-text-input id="inbound_active_days" name="inbound_active_days" type="text"
                                  class="mt-1 block w-full"
